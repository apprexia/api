...
import type { Verdict } from './interfaces/analysis-ai-result.interface';
...
export class AnalysesController {
    ...
    findAll(
        ...
        return this.analysesService.findAll(req.user.sub, Number(page), Number(limit), status, verdict);
    }
    ...
    @Patch(':id')
    @UseGuards(AuthGuard('jwt'))
    update(@Param('id') id: string, @Body() updateAnalysisDto: UpdateAnalysisDto, @Req() req) {
